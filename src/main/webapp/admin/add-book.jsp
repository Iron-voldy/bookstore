...
<head>
    ...
    <title>Add New Book - BookVerse Admin</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<%=request.getContextPath()%>/admin/add-book" method="post" enctype="multipart/form-data" id="addBookForm">
                    <div class="row">
                        <!-- Book Type Selection -->
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="preview-container" id="imagePreview">
                                <i class="fas fa-image fa-3x" style="color: var(--border-color);"></i>
                            </div>
                        </div>
                        ...
                        <div class="book-type-container" id="physicalBookFields">
                            <hr>
                        ...
                        <div class="book-type-container" id="ebookFields">
                            <hr>
    ...
    <script>
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                preview.innerHTML = `<i class="fas fa-image fa-3x" style="color: var(--border-color);"></i>`;
            }
        }
